...
if (opcion === '2' || methodCode) {
  ...
  if (MethodMobile) throw new Error('ⓘ Se produjo un Error en la API de movil')
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = 'Hola, *bienvenido a este grupo* espero que sea de tu agrado\n     *• 👤 Usuario:* @user\n     *•🪀 Asistente Virtual:* @SumiWaBot-MD\n    *•📅 Fecha:* @date\n    *•🕗 Hora:* @time\n\n💬 Porfavor te invito a leer la descripción del grupo:\n@desc'
  conn.bye = 'Adios, gracias por haber sido parte de este grupo esperemos que aya sido de su agrado.\n\n    *•👤 Usuario:* @user\n  *•📅 Fecha:* @date\n    *•🕗 Hora:* @time'
  conn.spromote = '*ⓘ* @user ha sido *promovió* a administrador de este grupo.'
  conn.sdemote = '*ⓘ* @user ha si *degradado* de administrador de este grupo.'
